...
def entry(
    ...
    sql = """
        INSERT INTO journals(
            ...
            journal.cost_type,
            journal.segment,
            journal.project_id if journal.project_id is not None else 'NULL',
            journal.fiscal_term,
            journal.month,
            journal.closed,
        ...
        for csv_rec in csv_records[1:]:
            ...
            if len(data) >= 16:
                ...
                journal = Journal(
                    ...
                    cash_out=data[11],
                    cost_type=data[12],
                    project_id=data[13] if data[13].isnumeric() else None,
                    fiscal_term=data[14],
                    month=data[15],
                    closed=data[16],
                )
        ...
        for csv_rec in csv_records[1:]:
            ...
            if len(data) >= 21:
                journal = Journal(
                    ...
                    tax_in=data[16],
                    tax_out=data[17],
                    project_id=data[18] if data[18].isnumeric() else None,
                    id=data[19],
                    fiscal_term=data[20],
                    month=data[21],
