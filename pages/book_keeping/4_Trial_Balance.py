...
for data in output(entried_at_from=entried_at_from, entried_at_to=entried_at_to):
    sheet.append({
        ...
        "借方(税込)": data.credit_actual_total_amount + data.credit_actual_total_tax,
        "貸方(税込)": data.debit_actual_total_amount + data.debit_actual_total_tax,
        "残高(税込)": data.balance_actual_amount + data.balance_actual_tax,
        "増減(税込)": (data.credit_actual_total_amount + data.credit_actual_total_tax) - (data.debit_actual_total_amount + data.debit_actual_total_tax),
        "仮受消費税": data.credit_actual_total_tax,
        "支払消費税": data.debit_actual_total_tax,
        "消費税 計": data.balance_actual_tax,
        "残高": data.balance_actual_amount + data.balance_actual_tax,
