...
<body>
    ...
    <h1 style="text-align: center; font-size: 24px; font-weight:bold;">請　求　書</h1>
    ...
    <br>
    <br>
    <div style="font-size: 14px;">上記の通り、ご請求申し上げます。お振込み手数料については貴社負担でお願いします。</div>
    <br>
    ...
    """ % (
        ...
        invoice_paper.account_information,
